...
class EducationTable extends Component {
  ...
  loadEducationData = () => {
    axios
      .get("https://ems-dummy.herokuapp.com/api/education/" + this.props.data["_id"], {
        headers: {
  ...
  onEducationDelete = (e1, e2) => {
    ...
    if (window.confirm("Are you sure to delete this record? ") == true) {
      axios
        .delete("https://ems-dummy.herokuapp.com/api/education/" + e1 + "/" + e2, {
          headers: {
            authorization: localStorage.getItem("token") || ""
          }
        })
  ...
  render() {
    return (
      <div id="table-outer-div-scroll">
        <h2 id="role-title">Education Details {this.props.back ? "of " + this.props.data["FirstName"] + " " + this.props.data["LastName"] : ""}</h2>
