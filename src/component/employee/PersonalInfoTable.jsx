...
class PersonalInfoTable extends Component {
  ...
  loadPersonalInfoData = () => {
    axios
      .get("https://ems-dummy.herokuapp.com/api/personal-info/" + this.props.data["_id"], {
        headers: {
  ...
  onPersonalInfoDelete = e => {
    ...
    if (window.confirm("Are you sure to delete this record? ") == true) {
      axios
        .delete("https://ems-dummy.herokuapp.com/api/personalInfo/" + e, {
          headers: {
            authorization: localStorage.getItem("token") || ""
          }
        })
  ...
  render() {
    return (
      <div id="table-outer-div-scroll">
        <h2 id="role-title">Personal Details {this.props.back ? "of " + this.props.data["FirstName"] + " " + this.props.data["LastName"] : ""}</h2>
        {/* 
        <Button
          variant="primary"
          id="add-button"
