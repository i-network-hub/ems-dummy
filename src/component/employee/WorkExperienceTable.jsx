...
class WorkExperienceTable extends Component {
  ...
  loadWorkExperienceData = () => {
    axios
      .get(
        "https://ems-dummy.herokuapp.com/api/work-experience/" + this.props.data["_id"], {
          headers: {
  ...
  onWorkExperienceDelete = (e1, e2) => {
    ...
    if (window.confirm("Are you sure to delete this record? ") == true) {
      axios
        .delete("https://ems-dummy.herokuapp.com/api/work-experience/" + e1 + "/" + e2, {
          headers: {
            authorization: localStorage.getItem("token") || ""
          }
        })
  ...
  render() {
    return (
      <div id="table-outer-div-scroll">
        <h2 id="role-title">Work Experience Details {this.props.back?"of " +this.props.data["FirstName"]+" "+this.props.data["LastName"]:""}</h2>
