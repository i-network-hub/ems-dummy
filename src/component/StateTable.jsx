...
class StateTable extends Component {
  ...
  loadStateData = () => {
    axios
      .get("https://ems-dummy.herokuapp.com/api/state", {
        headers: {
  ...
  onStateDelete = e => {
    ...
    if (window.confirm("Are you sure to delete this record ? ") == true) {
      axios
        .delete("https://ems-dummy.herokuapp.com/api/state/" + e, {
          headers: {
            authorization: localStorage.getItem("token") || ""
          }
        })
    ...
    // axios
    // .delete("https://ems-dummy.herokuapp.com/api/state", })
    // .then(response => {
    ...
    //   console.log(error);
    // });
    // axios.delete('https://ems-dummy.herokuapp.com/api/state')
    //      .then(res => console.log(res.data));
    // fetch("https://ems-dummy.herokuapp.com/api/state", {
    //   method: 'delete'
    // })
